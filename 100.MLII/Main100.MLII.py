...
sig, fields = wfdb.srdsamp('100', channels = [0])
...
plikcsv="COIF1.MLII.BPM.100.csv"
with open(plikcsv, 'w', newline='') as file:
    x = csv.writer(file, delimiter=';')
