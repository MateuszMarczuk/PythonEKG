...
rate = record.fs;
sig, fields = wfdb.srdsamp('230', channels = [1])
...
def wynik (max):
    ...
    SUMA=Suma(max)
    csvwynik2=[]
    csvwynik2.append([str(TP),str(FP),str(FN),str(SE),str(RR),str(SUMA)])
    return csvwynik2
